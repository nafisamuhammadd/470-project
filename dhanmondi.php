...
<div class="card w-100 text-center shadowBlue">
  ...
  <?php
      ...
      $array = $con->query("SELECT * from parking where location='Dhanmondi'or location='Kalabagan'or location='Kathalbagan' or location='Mohammadpur' or location='Newmarket' or location='Elephanroad'or location='Lalmatia' or location='Farmgate' or location='Adabor'");
      if ($array->num_rows > 0)
      {
